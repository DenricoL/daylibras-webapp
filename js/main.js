...
// seleciona uma palavra aleatória da lista de palavras alvo
var word = wordList[Math.floor(Math.random()*wordList.length)].toUpperCase(); // apresenta elas em maiúsculas
console.log(word);
